  ...
  const generateImage = async () => {
    if(form.prompt){
      try {
        ...
        const response = await fetch("https://pixelwiz.onrender.com/api/v1/dalle",{
          method: "POST",
          headers: {
      ...
      <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>
            ...
            flex justify-center items-center'>
              {form.photo ? (
                ...
                <img 
                  src= {preview}
                  alt='preview'
                  className='w-9/2 h-9/2 object-contain opacity-40'
                  />
              )}
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            text-sm w-full sm:w-auto py-2.5 px-5 text-center'
            >
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            ...
            with others in the community by clicking on the button below
          </p>
          <button
            type='submit'
